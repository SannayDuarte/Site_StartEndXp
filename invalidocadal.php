       ...
       // var_dump($dados);
        ...
        //TIPO ALUNO
            ...
            if(empty($dados['alnome']) || empty($dados['alcpf']) || empty($dados['alemail']) || empty($dados['alsenha'])){
             ...
             $query_usuario_email = "SELECT id FROM aluno WHERE (email=:alemail) LIMIT 1";
            ...
            header("Location: usuariocad.php");
             ...
             $query_usuario_cpf = "SELECT id FROM aluno WHERE (cpf=:alcpf) LIMIT 1";
        ...
        $query_pessoa = "INSERT INTO aluno( nome, cpf, email, senha) VALUES (:alnome, :alcpf, :alemail, :senha)";
  ...
  <div class="container" id="cads">
      <div class="nomes ">
          <div class="dados mb-6">
            <label>Nome</label>
            <input type="text" name="alnome" id="alnome" placeholder="Nome completo" ><br><br>
          </div>
          <div class="dados mb-6">
            <label>Cpf</label>
            <input type="text" name="alcpf" id="alcpf"  placeholder="CPF" ><br><br>
          </div>
          <div class="dados mb-6">
            <label>E-mail</label>
            <input type="text" name="alemail" placeholder="EMAIL" ><br><br>
          </div>
          <div class="dados mb-6">
            <label>Senha</label>
            <input type="password" name="alsenha" placeholder="Digite sua senha" ><br><br>
          </div>
